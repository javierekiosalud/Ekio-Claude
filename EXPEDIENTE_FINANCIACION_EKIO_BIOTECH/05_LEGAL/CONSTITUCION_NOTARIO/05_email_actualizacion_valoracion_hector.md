# EMAIL A HÉCTOR — ACTUALIZACIÓN DE VALORACIÓN Y CIERRE PARA FIRMA

**Para:** hector@martinezcortesmarcos.com
**Asunto:** Actualización de la valoración de la aportación — documentación para firma lunes/martes
...
Tras revisar el planteamiento con mi asesoría (Garrigues), hemos decidido pasar de una valoración a coste histórico de cada activo (que dejaba la aportación en 55.076 € de patrimonio neto) a una **valoración razonada de negocio en marcha**, que refleja mejor el valor real de la propiedad industrial, las marcas, el software y el fondo de comercio del negocio. Adjunto el detalle metodológico completo, pero el resumen es:

| Concepto | Valor |
|---|---|
| Activos tangibles (stock, equipos, local) | 63.555 € |
| Propiedad industrial (modelo de utilidad, PCT, segunda patente en desarrollo) | 90.000 € |
| Software propio | 18.000 € |
| Marcas y signos distintivos | 32.000 € |
| Dominio y tienda online | 15.000 € |
| Fondo de comercio del negocio en marcha (base de clientes, comunidad, contratos, know-how, valorado en conjunto) | 165.000 € |
| **Total activos aportados** | **383.555 €** |

**2. Cambio en el pasivo que se traspasa.**

Solo se traspasa la línea de crédito de CaixaBank, por su saldo dispuesto actualizado: **22.000 €** (no los 10.000 € de la versión anterior, ni el préstamo ICO, que se queda en mi esfera personal como autónomo).

**Balance de aportación resultante:**

| | |
|---|---|
| Activos aportados | 383.555 € |
| Pasivo asumido (línea de crédito) | -22.000 € |
...
*Adjunto: Inventario y valoración razonada completa (PDF)*
