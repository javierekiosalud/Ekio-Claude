...
## AVISO PREVIO — LO QUE NO HACE FALTA PREGUNTAR

Estos son **errores materiales evidentes** ya detectados. No gastes tiempo de la reunión en ellos; corrígelos directamente con la Notaría. Solo menciónaselos a Sara de pasada, como muestra de que el borrador necesita repaso:

| Dónde | Error |
|---|---|
| Estatutos Art. 3 | Dice "Benavente (Zamora)" — debe ser **"Cubo de Benavente"** |
| Escritura, cláusula SEGUNDO | Valor neto "36.276 €" — debe ser **55.076 €** (cifra correcta en el apartado I) |
| Escritura, cláusula fiscal | "Ley 39/1992" — la Ley del IVA es la **37/1992** |
| Escritura, PRIMERO y CUARTO | *"la socia fundadora"*, *"la Administradora designada"* — **femenino**, error de plantilla |
| Escritura | **Dos cláusulas numeradas OCTAVO** (tramitación telemática y cláusula fiscal) |
| Estatutos Art. 5 | Cita los *"artículos 61 a 65"* para la responsabilidad por la realidad y valoración de las aportaciones; esa responsabilidad está en los **arts. 73 y ss. LSC** |
| Estatutos Art. 2.e) | El objeto social termina en **"etc."** — el art. 178 RRM exige determinación del objeto; puede ser calificado negativamente |
| Escritura, apartado I | Faltan por rellenar: fecha de nacimiento, fecha del balance, denominación, elección de notario |
...
**Lo que dice la escritura:** el apartado e) advierte que, pese a las exclusiones pactadas, hay deudas que se transmiten **por imperativo legal**, entre ellas *"ciertas deudas tributarias (art. 42.1 L.G.T.)"* y las de Seguridad Social.

**El problema:** la sociedad responderá solidariamente de las deudas tributarias derivadas de mi actividad como autónomo, **con independencia de lo que pactemos en la escritura**. La LGT ofrece un mecanismo para limitar esa responsabilidad: solicitar a la AEAT, antes de la operación, una **certificación detallada de deudas y responsabilidades tributarias (art. 175.2 LGT)**; si se emite sin deudas, o si transcurre el plazo sin emitirse, la responsabilidad del adquirente queda limitada.

**Pregunta:** *"¿Debo solicitar el certificado del art. 175.2 LGT (y el equivalente de Seguridad Social) **antes de firmar** para limitar la responsabilidad de la sociedad por sucesión de actividad? ¿Cuánto tarda y llegamos a tiempo para la firma prevista en julio/agosto? ¿Merece la pena retrasar la firma para tenerlo?"*

> **Por qué es la nº 1:** es la única de la lista que puede evitar que la sociedad nazca respondiendo de deudas fiscales tuyas de años anteriores. Y tiene una ventana temporal: hay que pedirlo ANTES. La escritura advierte del riesgo pero no propone el remedio.
...
**Pregunta:** *"¿Cuál es el **plazo y la forma vigentes** para comunicar a la AEAT el acogimiento al régimen de neutralidad fiscal, **quién debe presentarla** (la sociedad, yo como aportante, o ambos), y qué ocurre exactamente si se presenta fuera de plazo — se pierde el régimen, o es una infracción formal sancionable pero subsanable?"*

> **Por qué:** el requisito de comunicación se ha modificado varias veces en los últimos años. Es puramente formal, pero un despiste aquí puede costar el diferimiento fiscal de toda la operación.
...
**El problema:** el negocio tiene deudas vivas (ICO, línea de crédito dispuesta), y en un negocio de e-commerce con stock es habitual tener facturas de proveedores pendientes de pago en cualquier momento dado. Además, **la cláusula d) advierte del art. 66 LSC**: como aportante de una empresa, quedo obligado al saneamiento si un vicio o la evicción afectan a *"elementos esenciales para su normal explotación"*.

**Pregunta:** *"¿Es compatible esta manifestación con tener stock cuyo pago a proveedores pueda estar pendiente y con las deudas bancarias que la sociedad asume? ¿Cómo debería matizarse para que sea **exacta y no me exponga a responsabilidad por manifestación inexacta**? Y respecto al saneamiento del art. 66 LSC: si mañana se cuestionara la titularidad del software (desarrollado por un empleado sin cláusula de cesión de IP y con un tercero, AIR Institute) o la marca EKIO LIGHT no llegara a concederse, **¿respondo personalmente por ser 'elementos esenciales'**?"*

> **Por qué:** esta manifestación es la que activa tu responsabilidad personal. Firmarla sin matizar, con deudas comerciales vivas y con una cadena de titularidad de software que sabemos que no está blindada, es asumir un riesgo evitable.
...
- Pero el objeto social de los estatutos se ha ampliado con biotecnología, tecnología de la salud, desarrollo de IA y un extenso listado de servicios informáticos, que van mucho más allá de mi actividad real.
- Y la escritura fija como CNAE principal el **2611 (fabricación de componentes electrónicos)**, cuando la mayor parte de mi facturación es **comercio electrónico y consultoría**.

**Pregunta:** *"¿Genera riesgo, para la no sujeción a IVA o para el régimen FEAC, que el objeto social sea sustancialmente más amplio que la actividad realmente transmitida? Y sobre el CNAE: **¿es 2611 el código correcto como actividad principal**, siendo mi facturación mayoritariamente venta online y consultoría? ¿Qué implicaciones tiene el CNAE elegido para el alta censal, los epígrafes de IAE, y sobre todo **para el acceso a subvenciones y ayudas que discriminan por código de actividad**?"*

> **Por qué:** el CNAE parece un detalle administrativo y no lo es — condiciona qué convocatorias de ayudas te encajan, y estás buscando financiación pública activamente.
...
**Pregunta:** *"¿Puede la sociedad subrogarse como beneficiaria de estas subvenciones —asumiendo las obligaciones de mantenimiento pendientes— o requiere **autorización expresa previa** del órgano concedente? Teniendo una deuda de reintegro pendiente con la misma Junta, **¿puede eso bloquear la autorización del cambio de titular, o puede la administración compensar** un pago pendiente de una subvención con la deuda de reintegro de otra? Y para la que está en tramitación: ¿conviene pedir ya el cambio de solicitante a nombre de la sociedad, antes de que se resuelva?"*
...
**Pregunta:** *"¿Es jurídicamente coherente afirmar que se aporta 'la totalidad' del patrimonio empresarial y excluir simultáneamente tres elementos? ¿Podría un registrador o la AEAT interpretarlo como una **aportación parcial disfrazada de total**, con consecuencias para el régimen FEAC?"*
...
**Pregunta:** *"Esta cláusula es de una amplitud total y aparece después de la lista de exclusiones. ¿Queda suficientemente claro que **el préstamo de Iberaval y el reintegro de la subvención NO se transmiten**, o hay riesgo de contradicción interna? ¿Reforzaríais la redacción con una remisión expresa ('salvo los elementos expresamente excluidos en el apartado I')?"*
...
**El problema de fondo:** el art. 87.1 LIS exige que el aportante persona física lleve **contabilidad ajustada al Código de Comercio**. Yo llevo la contabilidad de mi actividad con Holded.

**Pregunta:** *"¿Qué **antigüedad máxima** admite el balance que se protocoliza? Mi stock se vende a diario, así que la cifra de 55.076 € variará entre la fecha del balance y la firma — **¿cómo se maneja esa desviación** sin comprometer la exactitud de la escritura? Y la pregunta de fondo: **¿mi contabilidad actual cumple el requisito del art. 87.1 LIS?** Si no, ¿qué hay que regularizar y con cuánta antelación?"*
...
> *"Se incluyen igualmente en la presente transmisión, sin valoración contable individualizada por constituir fondo de comercio inherente a la unidad económica que se transmite en su conjunto (arts. 87 LIS y NRV 5ª y 19ª del PGC), las bases de datos de clientes y contactos, las cuentas y perfiles en redes sociales y plataformas digitales, los contratos comerciales vigentes y el know-how del negocio."*

**Pregunta:** *"¿Es la fórmula correcta, o recomendaríais otra? ¿Hay riesgo de que, al no llevar valor asignado, se cuestione después que realmente se transmitieron —por ejemplo, en una disputa sobre la validez del cambio de responsable del tratamiento a efectos de RGPD?"*
...
**Pregunta:** *"Esta cláusula establece arbitraje **de equidad** (no de derecho) y **no designa institución arbitral ni sede**, lo que lo convierte en un arbitraje ad hoc. ¿Es esto habitual y recomendable en una sociedad que va a recibir inversores institucionales — o **preferirán arbitraje de derecho ante una corte concreta**, o directamente jurisdicción ordinaria? ¿Conviene cambiarlo ahora?"*
...
**Pregunta:** *"Voy a ser socio único, administrador único **y la persona que dirige la operativa diaria**. Esa exclusión de la alta dirección, ¿me deja alguna vía para retribuir mi trabajo ejecutivo al margen del cargo de administrador, o por la doctrina del vínculo todo debe canalizarse como retribución de administrador? **¿Qué combinación es óptima** entre asignación de administrador, nómina y dividendo, considerando RETA y la deducibilidad en el Impuesto sobre Sociedades? Y como la sociedad nace **sin tesorería**: ¿puedo dejar la cláusula como está y simplemente no aprobar asignación hasta que haya ingresos, o es preferible constituir con el cargo gratuito?"*
...
**Pregunta:** *"Esta facultad de avalar a terceros es muy amplia. En mi caso concreto es sensible, porque **mi sociedad anterior (EKIO Bienestar) avala un préstamo mío de 80.000 €** y podría plantearse en el futuro que Ekio BioTech sustituyera ese aval. ¿Debe limitarse estatutariamente esta facultad, o se deja abierta y se controla vía pacto de socios cuando entren inversores?"*
...
**Pregunta:** *"Esta redacción es **gramaticalmente ambigua**: no queda claro si las sociedades del mismo grupo están **incluidas en las excepciones** (junto a socios y familiares, es decir, transmisión libre) o si están **sujetas** al procedimiento de comunicación y adquisición preferente. Necesito que la transmisión de mis participaciones a la futura Ekio Holdings sea libre. ¿Cómo se interpreta tal como está, y **cómo lo redactaríais para que no haya duda**?"*
...
**Pregunta:** *"Los inversores suelen pedir **preferencia en la liquidación** y, a veces, vincular al fundador mediante prestaciones accesorias o cláusulas de permanencia. ¿Conviene dejar ya prevista en estatutos la **posibilidad de crear clases de participaciones**, para no tener que modificar estatutos en plena negociación de la ronda, o es mejor mantenerlos simples y afrontarlo entonces?"*
...
**Pregunta:** *"¿Qué **obligaciones de información y consulta** genera esta operación respecto al trabajador (no hay representación legal de los trabajadores), y con qué antelación deben cumplirse? ¿Aplica algo del RDL 5/2023 a una aportación de negocio de persona física a sociedad, o basta con el art. 44 ET?"*
...
**Pregunta:** *"¿Cómo blindo la titularidad al 100 % a favor de la sociedad? ¿Basta un **addendum al contrato de Cristian**, y debe ser anterior a la firma de la escritura? Sobre AIR Institute: si el contrato establece cotitularidad, **¿puedo aportar ese software a la sociedad sin su consentimiento**, o necesito autorización previa? ¿Y qué exposición tengo por el saneamiento del art. 66 LSC si esto se cuestiona después?"*
...
**Pregunta:** *"¿Es exigible la declaración de titularidad real en una unipersonal donde el socio único comparece? ¿Y qué **obligaciones formales inmediatas** tiene la sociedad tras la constitución — legalización de libros, libro registro de socios, alta censal, plazos?"*
...
**Pregunta:** *"La sociedad tendrá que afrontar desde el día uno gastos de notaría, registro, gestoría y operativa corriente **sin tesorería**. ¿Es un problema práctico o jurídico relevante? ¿Cómo se financia esa primera fase — **préstamo del socio, cuenta corriente con el socio**, aportación dineraria complementaria — y cuál de esas fórmulas es más limpia de cara a la entrada posterior de inversores y a la calificación de empresa emergente?"*
...
## DATOS DEL CASO (por si preguntan cifras)

- Facturación ~600.000 €/año (≈1,8 M€ en 3 años). Margen bruto paneles 50 %. **Tesorería: 0 €.**
- Aportación: activos **71.805 €** · pasivos asumidos **16.729 €** (ICO 6.729 + línea de crédito dispuesta 10.000) · **patrimonio neto 55.076 €** → capital 10.000 € + prima de asunción 45.076 €.
- Excluido del aporte: préstamo Iberaval 80.000 € (avalado por EKIO Bienestar S.L., que queda inactiva), reintegro de subvención Junta CyL 7.000 €, marca EkoWifi (M 4286006).
- Propiedad industrial: modelo de utilidad **U202532624** · nombre comercial **EKIO ELECTROSMOG N 0467723** (concedido) · solicitud de marca **EKIO LIGHT M 4357232** (pendiente de confirmar si ya concedida) · PCT en preparación, **tope de prioridad 24/12/2026**.
