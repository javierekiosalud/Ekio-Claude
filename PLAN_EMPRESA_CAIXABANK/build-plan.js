...
children.push(bullet([b('Propiedad industrial: '), run('Modelo de Utilidad español Nº U202532624 (panel multiespectral), presentado ante la OEPM el 25 de diciembre de 2025 y en tramitación. Solicitud PCT (internacional) en preparación. Es un elemento diferenciador frente a competidores, pendiente de concesión.')]));
children.push(bullet([b('Desarrollo tecnológico: '), run('sistema SFPA (plataforma de fotobiomodulación adaptativa con inteligencia artificial), en desarrollo con AIR Institute (Salamanca), con tramitación de PCT independiente. En fase de desarrollo, sin producto comercial todavía.')]));
...
children.push(bullet([b('Fotobiomodulación (terapia de luz roja e infrarroja). '), run('Categoría de producto de consumo dentro del bienestar, la recuperación deportiva y el cuidado de la piel, con oferta creciente de equipos domésticos. Ekio compite en ella con producto propio (Ekio Light) y con propiedad industrial en tramitación como elemento diferenciador.')]));
...
children.push(bullet([b('AIR Institute (Salamanca). '), run('Colaboración científica para el desarrollo del sistema SFPA (fotobiomodulación adaptativa con inteligencia artificial).')]));
...
children.push(p('La actividad económica de Ekio —desarrollada desde 2023 como empresario individual y continuada en 2026 por EKIO BIOTECH, S.L.U.— presenta tres ejercicios consecutivos en beneficios. La cuenta de resultados simplificada, con el coste de ventas deducido de forma implícita a partir del margen bruto declarado, es la siguiente:'));
children.push(h2('6.1. Cuenta de resultados histórica simplificada'));
children.push(table(
  ['Concepto', '2024', '2025', '2026 (H1, ene–jun)'],
  [
    ['Facturación (€)', '534.504', '537.845', '207.815'],
    ['Margen bruto (%)', '38,4 %', '24,5 %', '55,9 %'],
    ['Margen bruto (€)', '205.250', '131.772', '116.169'],
    ['Coste de ventas implícito (€)', '329.254', '406.073', '91.646'],
    ['Resultado del ejercicio (€)', '+52.493', '+19.301', '+78.738'],
  ],
  [3026, 2000, 2000, 2000],
  [undefined, R, R, R],
));
children.push(spacer());
children.push(p([it('El coste de ventas y el margen bruto en euros son los implícitos por el margen bruto (%) de gestión (facturación × (1 − margen bruto %)); no son partidas independientes tomadas de Holded. El margen bruto de 2026 corresponde al margen bruto global de la tienda en el primer semestre.', { italics: true })]));
children.push(h2('6.2. Lectura de gestión'));
children.push(bullet([b('Tres ejercicios consecutivos en beneficios. '), run('2024 (+52.493 €), 2025 (+19.301 €) y el primer semestre de 2026 (+78.738 €). La facturación acumulada de la actividad desde 2023 supera 1,7 M€ (cifra acumulada del periodo, no anual).')]));
...
children.push(h2('8.3. Necesidad estimada de circulante para la campaña Q4'));
...
children.push(h2('8.4. Garantías y estructura de la operación'));
...
children.push(h1(9, 'Capacidad de devolución'));
...
children.push(h2('9.1. Flujo de caja de campaña (escenario base, octubre 2026 – febrero 2027)'));
...
children.push(p([it('El total de «flujo de caja libre del mes» (+100.774 €) es el flujo operativo de campaña de la sección 9.2 (107.525 €) menos el servicio del préstamo de 70.000 € en el periodo (6.750 €); la diferencia de 1 € es redondeo.', { italics: true })]));
children.push(h2('9.2. Ratio de cobertura de la devolución'));
...
children.push(h2('9.3. Estrés severo: pedido comprometido y ventas −40 %'));
...
children.push(h2('9.4. Efecto del préstamo de 70.000 €'));
...
children.push(h2('9.5. Conclusión sobre solvencia'));
...
children.push(h2('10.1. Anexo financiero (Excel)'));
...
children.push(bullet('Histórico — cuenta de resultados 2024 / 2025 / 2026 H1 con gráfico de facturación y margen.'));
...
children.push(h2('10.2. Documentación de soporte a aportar con la solicitud'));
...
children.push(h2('10.3. Lista consolidada de datos pendientes de aportar por la empresa'));
...
[
  ...
  'Facturación del ejercicio 2023 y cierre provisional a julio/agosto de 2026; informe de Holded actualizado.',
