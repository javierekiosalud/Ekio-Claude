...
### 🔴 D1 — La página del menú es un folleto vacío
544 palabras, 4 headings genéricos ("Revoluciona Tu Bienestar", "¿Buscas Mejorar Tu Bienestar…?"), los productos aparecen **una sola vez cada uno**, sin precios, sin comparativa, sin FAQ, sin camino de decisión. El visitante que clica "TERAPIA DE LUZ ROJA" en el menú (230 clics en el heatmap de la home) aterriza en una página que no le deja comprar ni elegir.

### 🔴 D2 — Clúster "luz roja": ~1.300 impresiones/mes, 9 clics (CTR 0,7%)
| Query | Imp | Pos | Clics | Dónde aterriza |
|---|---|---|---|---|
| luz roja | 207 | 9,5 | 1 | Colección |
| lampara luz roja (+variantes) | ~200 | 10–12 | 0 | Colección/WP antigua |
| **terapia de luz roja** (+variantes) | ~150 | 8,8–26 | 0 | Hub y WP antigua |
| luz roja comprar / comprar luz roja | 90 | 10 | 2 | Colección |
| **luz roja 727 nm** | 11 | **1,0** | 0 | WP antigua |
| **terapia de luz roja en casa** | 7 | **1,0** | 0 | WP antigua |

Mismo patrón que filtros: posiciones página 1-2 con snippets que no ganan el clic. Meta actual: "…Visita Web Ahora!" (relleno).
**Nota**: las URLs WordPress antiguas ya redirigen bien (301 directas) — la consolidación llegará sola; no tocar.

### 🟠 D3 — Reparto de roles hub vs colección (mantener, clarificar)
GSC ya reparte bien: la **colección** captura lo transaccional ("lámpara", "comprar", "panel") y el **hub** lo educacional-decisional ("terapia de luz roja…"). El rediseño debe reforzar ese reparto: hub = educar + comparar + elegir; colección = grid de compra. Interlink con anchors exactos en ambas direcciones.

### 🟢 D4 — Dos posiciones nº1 que son oro y nadie explota
...
## LA GAMA (fuente: landings existentes + decisión Javier 6-jul)
...
La tabla de la sección "LA GAMA" de arriba, en HTML real, con fila final de precio+CTA por columna.
Cierre: `¿Dudas? Escríbenos por WhatsApp y te ayudamos a elegir` *(o el canal que prefiráis — aquí NO va el test de SPIRO)*

### 4. QUÉ ES LA FOTOBIOMODULACIÓN (bloque definicional GEO)
**H2:** `¿Qué es la fotobiomodulación?`
> La **fotobiomodulación** es el uso de luz roja e infrarroja en longitudes de onda específicas (600–1.100 nm) para estimular la función celular. La luz penetra en el tejido y actúa sobre las mitocondrias — en concreto sobre la enzima citocromo c oxidasa — favoreciendo la producción de energía celular (ATP). Cuenta con miles de estudios publicados y se usa en clínicas de fisioterapia, dermatología y medicina deportiva. Con un panel adecuado, puedes aplicar **terapia de luz roja en casa**.

*(65 palabras, citable. Enlace a estudios/blog FBM.)*
...
2. **¿Puedo hacer terapia de luz roja en casa?** *(query en pos 1)* — sí + cómo: panel, distancia, minutos, constancia
...
`ELEGIR MI PANEL →` (comparativa) · `VER LA GAMA COMPLETA` (colección)
...
## CHECKLIST DE LANZAMIENTO (coordinar con el alta de productos)
1. Crear/renombrar los 4 productos en Shopify (Deep 7 Cyan → Bio Regén 7; Full Spectrum 10 → Bio Spectrum 11; IGNIS → Core) **con redirects 301 de las URLs antiguas de PDP**
2. Pegar las landings existentes en las PDPs nuevas
3. Publicar el hub nuevo (esta página)
4. Actualizar colección: títulos, orden escalera, fotos
5. Añadir schema ItemList + FAQPage
