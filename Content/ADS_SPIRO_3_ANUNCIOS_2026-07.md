# 3 ANUNCIOS DE SPIRO DERIVADOS DE ORGÁNICO VALIDADO
### Brief completo de campaña + creativos · 24 julio 2026
**Base de decisión:** [ANALISIS_IG_ORGANICO_2026_TOP_CONTENIDO.md](ANALISIS_IG_ORGANICO_2026_TOP_CONTENIDO.md) — datos reales de Meta Business Suite (1 ene – 24 jul 2026) + insights reales de la cuenta `act_1023837348829063`.
...
El contraste que decide todo el brief:
...
**83× de diferencia con el mismo producto y la misma keyword.** Los 3 anuncios están construidos sobre el mecanismo, nunca sobre el producto.

---

## RESUMEN DE LOS 3

| | **AD A · El precio invisible** | **AD B · La medición** | **AD C · El bolsillo** |
|---|---|---|---|
| Origen orgánico | 2,92 M views · 138.416 shares | 1,24 M views · mejor retención 3s del año | 1,10 M views · 2.304 comentarios |
| Mecanismo | Objeto cotidiano cuestionado | Demostración con medidor | Amenaza íntima concreta |
| Gancho 0-3s | Mano sacando auriculares del estuche | Pantalla del medidor: 1.157.000 µW/m² | Mano metiendo el móvil en el bolsillo |
...
Todos excluyen la Custom Audience de compradores Spiro desde Klaviyo. Todos en Reel vertical 9:16, 25-35s. Sin carruseles: en esta cuenta topan en ~20.000 views frente a los millones de los Reels.
...
> **Prueba técnica obligatoria antes del rodaje:** grabar la pantalla del medidor con el móvil y verificar que el número se lee en vertical a tamaño real. Es el punto de fallo más probable de todo el brief.
...
Prohibido en los tres: claims médicos absolutos, antes/después de salud, imágenes clínicas (escáneres, células, espermatozoides, órganos), porcentajes de riesgo sin el paper completo citado, atacar fabricantes por nombre, exclamaciones alarmistas.

### Riesgo por anuncio
- **AD B — bajo.** Un número verificable con referencia externa (Building Biology) es el formato más seguro en Meta: no es EKIO afirmando el daño, es una norma externa fijando el umbral.
- **AD A — medio.** Permitido cuestionar el hábito; prohibido vincularlo a una condición médica.
- **AD C — alto.** Meta clasifica automáticamente salud reproductiva como health claim. Por eso se lanza el último y con el presupuesto más bajo: si lo tumban en 3 días se pierden 45€, no 300€. Se lanzan simultáneamente dos formulaciones (cita de estudio verificable vs. pregunta + dato) para ver cuál pasa revisión **y** cuál convierte. Si el ángulo no puede formularse de forma que pase, el anuncio no tiene versión viable — no se fuerza.

---

## DIAGNÓSTICO: POR QUÉ SPIRO HACE 0,87x Y LUZ ROJA 10,96x

Cinco causas acumuladas. Ninguna basta por sí sola:

1. **No existe L1 que alimente el retargeting de Spiro.** Deep 5 tiene embudo completo (L1 EDU → L2 frío → L2 RT → L3 recovery). Spiro en pago existe **solo** como L2 RT. Es un L3 sin L1 ni L2 detrás.
2. **La audiencia de RT está quemada.** Frecuencia 2,81 con ROAS 0,87x: la han visto casi 3 veces y no compran. No es un problema creativo, es un pool agotado.
...
**Producción** (distinto del lanzamiento): AD B primero — necesita la prueba técnica del medidor. Luego AD A (el más simple de rodar). Luego AD C (requiere la infografía en post).

**Lanzamiento:**
- **Semana 1 — AD A.** Más evidencia orgánica (4,5 M views en el mismo ángulo sumando los dos reels de auriculares), riesgo de policy casi nulo, audiencia más amplia. Genera el benchmark real de CPM/CTR/CPA de la cuenta y empieza a reconstruir el pool de retargeting.
- **Semana 2 — AD B.** Con 7 días de datos de A ya hay referencia de CPM del mercado español. Es el de mejor ecuación de ROAS y debe lanzarse con benchmark en mano.
- **Semana 3 — AD C.** El más arriesgado va el último: si Meta lo rechaza, A y B ya están generando datos, y el targeting manual de C se informa con lo que hayan revelado.

---

## SIGUIENTE PASO RECOMENDADO
Landing específica para el tráfico frío de **AD B**: quien llega ha visto el medidor y necesita encontrar, antes del fold, la explicación de por qué SPIRO no baja la lectura. Ese hueco entre expectativa y realidad es la primera objeción que la página tiene que resolver.
