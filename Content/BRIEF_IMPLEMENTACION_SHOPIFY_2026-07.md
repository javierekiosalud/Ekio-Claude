...
| 1.3 | **IGNIS → Core** | Renombrar a "Ekio Light Core — Terapia de Luz Local Portátil", precio **140 €**, specs: 13 LEDs, 2 longitudes de onda, sin COB, diferenciador terapia local/portátil. 301 de `/products/ignis...` ✓. **La landing del Core no existe aún → la redacto yo en cuanto me deis luz verde (siguiente tarea de copy)** |
